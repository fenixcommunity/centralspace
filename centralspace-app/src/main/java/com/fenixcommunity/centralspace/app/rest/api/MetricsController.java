...
public class MetricsController {
    ...
    public ResponseEntity<String> getMetrics(@PathVariable("metricsName") final MetricsName metricsName) {
        return ResponseEntity.ok( "Total amount: " + metricsService.getSummary(metricsName).totalAmount());
    }
