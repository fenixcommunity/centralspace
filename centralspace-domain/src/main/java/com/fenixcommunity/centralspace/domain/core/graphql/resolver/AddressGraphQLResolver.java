...
public class AddressGraphQLResolver implements GraphQLResolver<AddressGraphQLDto> {

    public List<AccountGraphQLDto> getAccounts(final AddressGraphQLDto address) {
        return address.getAccounts();
    }
}